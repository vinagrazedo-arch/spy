...
-- Linha 2750 (aproximadamente)
-- MODIFICADO: Tema "Drácula" by Manus
local Highlighter = {
	Colors = {
		Keyword = "#ff79c6",       -- Palavras-chave (if, else, for) em ROSA
		String = "#f1fa8c",        -- Strings ("texto") em AMARELO
		Number = "#bd93f9",        -- Números em ROXO CLARO
		Nil = "#bd93f9",           -- Cor de 'nil'
		Boolean = "#bd93f9",       -- Cor de 'true' e 'false'
		Function = "#ff79c6",      -- Cor da palavra 'function'
		Self = "#ff79c6",          -- Cor de 'self'
		Local = "#ff79c6",         -- Cor de 'local'
		Text = "#f8f8f2",          -- Cor do texto padrão (branco suave)
		LocalMethod = "#50fa7b",   -- Métodos em VERDE LIMA
		LocalProperty = "#8be9fd", -- Propriedades em CIANO CLARO
		BuiltIn = "#8be9fd",       -- Funções nativas (print, wait) em CIANO CLARO
		Comment = "#6272a4",       -- Comentários em um roxo/cinza dessaturado
	},
...
local function getcallingfunction()
	local BaseLevel = if wax.shared.ExecutorSupport["oth"] then 2 else 4
...
BackgroundColor3 = Color3.fromRGB(40, 42, 54), -- Roxo/Azul escuro do tema Drácula
